  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-8">
    <div className="divide-y divide-gray-200 rounded-xl border border-gray-200 shadow-sm">
      <div className="p-4 sm:p-6">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-2xl font-bold text-gray-900 sm:text-3xl">$0</strong>
          <span className="text-sm font-medium text-gray-700">/month</span>
        </p>
        <a
          className="mt-4 block rounded border border-indigo-600 bg-indigo-600 px-8 py-2 text-center text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 sm:mt-6"
          href="#"
        >
          Get Started
        </a>
    ...
    <div className="divide-y divide-gray-200 rounded-xl border border-gray-200 shadow-sm">
      <div className="p-4 sm:p-6">
        ...
        <p className="mt-2 text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        <p className="mt-2 sm:mt-4">
          <strong className="text-2xl font-bold text-gray-900 sm:text-3xl">$5</strong>
          <span className="text-sm font-medium text-gray-700">/month</span>
        </p>
        <a
          className="mt-4 block rounded border border-indigo-600 bg-indigo-600 px-8 py-2 text-center text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 sm:mt-6"
      ...
      <div className="p-4 sm:p-6">
        ...
        <ul className="mt-2 space-y-2 sm:mt-4">
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700">30 users</span>
          </li>
          <li className="flex items-center gap-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
